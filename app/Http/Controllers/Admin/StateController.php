...
use App\resources\Admin\State\StateCollection;
use App\resources\Admin\State\StateResource;
...
class StateController extends Controller
{
    ...
    public function __construct(StateRepository $stateRepository)
    {
        ...
        $this->middleware(['ability:admin,states-read'])->only(['index', 'show', 'getByCountryId']);
        $this->middleware(['ability:admin,states-create'])->only(['store']);
        $this->middleware(['ability:admin,states-update'])->only(['update']);
        $this->middleware(['ability:admin,states-delete'])->only(['destroy', 'forceDelete', 'restore', 'getOnlyTrashed']);
    }
    /**
