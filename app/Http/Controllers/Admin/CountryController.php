...
class CountryController extends Controller
{
    ...
    public function __construct(CountryRepository $countryRepository)
    {
        ...
        $this->middleware(['ability:admin,countries-read'])->only(['index', 'show']);
        $this->middleware(['ability:admin,countries-create'])->only(['store']);
        $this->middleware(['ability:admin,countries-update'])->only(['update']);
        $this->middleware(['ability:admin,countries-delete'])->only(['destroy', 'forceDelete', 'restore', 'getOnlyTrashed']);
    ...
    {
        try {
            $data = $this->countryRepository->getAll()->get();
