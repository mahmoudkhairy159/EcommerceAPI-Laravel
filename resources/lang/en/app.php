...
return [
    ...
    "referenceCustomers" => [
        ...
        "referenceCustomers" => "referenceCustomers",
        "show" => "Show carts",
        "create" => "create a Reference Customer",
        "update" => "update a Reference Customer",
        "delete" => "delete a Reference Customer",
        "destroy" => "destroy a Reference Customer",
        "created-successfully" => "Reference Customer created successfully",
        "updated-successfully" => "Reference Customer updated successfully",
        "deleted-successfully" => "Reference Customer deleted successfully",
        "restored-successfully" => "Reference Customer restored successfully",
        "created-failed" => "Reference Customer created failed",
        "updated-failed" => "Reference Customer updated failed",
        "deleted-failed" => "Reference Customer deleted failed",
        "restored-failed" => "Reference Customer restored failed",
    ],
    "contactMessages" => [
